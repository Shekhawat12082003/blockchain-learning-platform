...
/**
 * Enhanced AI Service for Learning Tutor
 * Features: Teaching, Quizzes, Explanations, Study Plans, Progress Analysis
 */
...
class EnhancedAIService {
  ...
  /**
   * Main teaching method - Adaptive responses based on learning needs
   */
...
Format as a clear, actionable plan.`;
  ...
  /**
   * Analyze user's learning progress and provide feedback
   */
...
6. Adjusted learning strategy`;
  ...
  /**
   * Get practice problems/exercises
   */
...
Make problems progressively challenging and educational.`;
  ...
  /**
   * Helper: Build teaching system prompt
   */
...
Be patient, encouraging, and thorough. Your goal is mastery, not just information transfer.`;
  ...
  /**
   * Helper: Try a specific AI provider
   */
